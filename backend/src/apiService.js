...
export const apiService = {
  // Save new event from CreateEvent.jsx
  ...
  // Fetch real participants for Participants.jsx
  ...
  // Fetch dashboard stats for Home.jsx
  getStats: async () => {
  ...
  // Fetch real volunteers for Volunteers.jsx
  getVolunteers: async () => {
    const res = await fetch(`${API_URL}/volunteers`);
    if (!res.ok) throw new Error("Failed to fetch volunteers");
    return res.json();
  },
  // Fetch real resources for Resources.jsx
  getResources: async () => {
